...
import 'package:megadey_mobile/views/view_store/view_store_viewmodel.dart';
import 'package:stacked/stacked.dart';
import 'package:stacked_services/stacked_services.dart';
import '../../core/constants/colors.dart';
import '../../core/utilities/widgets/category_filter.dart';

class ViewStoresView extends StatelessWidget {
  static const routeName = 'viewStoresView';

  const ViewStoresView({super.key});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<ViewStoresViewModel>.reactive(
        onModelReady: (model) => model.setup(context),
        viewModelBuilder: () => ViewStoresViewModel(),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(image: AssetImage(model.storeBanner ?? ''),fit: BoxFit.fill)
                            ),
                          ),
                          const SizedBox(height: 20),
                          Text(
                            ViewStoresViewModel.storeName ?? '',
                            style: TextStyle(
  ...
  Widget appBar(ViewStoresViewModel model,BuildContext context){
    return Container(
  ...
  Widget _searchWidget(ViewStoresViewModel model, BuildContext context, TextEditingController controller) {
    return Padding(
  ...
  Widget _suggestionsView(ViewStoresViewModel model) {
    return Padding(
        padding: const EdgeInsets.symmetric(horizontal: 20.0),
  ...
  Widget listViewOfProducts(ViewStoresViewModel model){
