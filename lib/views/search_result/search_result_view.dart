...
class SearchResultView extends StatelessWidget {
                                  ...
                                  child: Text.rich(
                                    TextSpan(
                                      children: [
                                        ...
                                        TextSpan(
                                          text: '${SearchResultViewModel.searchValue}',
                                          style: TextStyle(
  ...
  Widget appBar(SearchResultViewModel model,BuildContext context){
    return Padding(
  ...
  Widget _searchWidget(SearchResultViewModel model, BuildContext context, TextEditingController controller) {
    return Column(
      children: [
        SizedBox(height: 20),
        Padding(
  ...
  Widget _suggestionsView(SearchResultViewModel model) {
    return Padding(
        padding: const EdgeInsets.symmetric(horizontal: 20.0),
  ...
  Widget listViewOfProducts(SearchResultViewModel model){
  ...
  Widget gridViewOfProducts(SearchResultViewModel model){
